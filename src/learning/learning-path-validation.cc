...
//          (adapted from Pierre Ferenbach's code: dynamic-path-validation.cc)
//
...
#include <hpp/rbprm/learning/learning-path-validation.hh>
...
namespace hpp {
  namespace rbprm {
    ...
    bool LearningPathValidation::validate (const core::PathPtr_t& path, bool reverse, core::PathPtr_t& validPart, core::PathValidationReportPtr_t& validationReport,const std::vector<std::string>& filter){
